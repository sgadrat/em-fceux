...
//HACK
// As of emscripten 3.1.51 (probably from 3.1.48)
// There are unprodetected asserts in library_browser.js which will be undefined when compiled with "-sSTRICT -sASSERTIONS=0"
//  Let's add a dummy assert implementation
if (typeof(window.assert) === 'undefined') {
	window.assert = function(cond, msg) {
		console.log('assert('+cond+', "'+msg+'")');
	};
}
